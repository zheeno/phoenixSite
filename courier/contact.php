<html>
<head>
    <title>weSendIt - Contact Us</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <link rel="shortcut icon" href="../assets/img/weSendIt.png" />
    <!-- Font Awesome -->
...
<body class="bg-white">
    <div class="container-fluid">
        <nav class="row navbar navbar-expand-lg bg-white pad-0">
            <!-- Collapsible content -->
        <a>
            <img src="../assets/img/weSendIt.png" style="width:80px;margin:10px">
        </a>
        ...
        <footer class="row pad-top-25 pad-bot-25">
            <div class="col-12 center-align">
                <small class="grey-text ">Copyright &copy; weSendIt Courier Limited</small>
            </div>
        </footer>
    </div>
</body>
